resource "azurerm_storage_account" "storage_account" {
  name                     = "saaccountingsystem${var.environment}"
...
resource "azurerm_storage_container" "blob_db_knowledge_container" {
  name                  = "db-knowledge"
  storage_account_name  = azurerm_storage_account.storage_account.name
  container_access_type = "private"
}

resource "azurerm_storage_container" "blob_db_vectors_container" {
  name                  = "db-vectors"
  storage_account_name  = azurerm_storage_account.storage_account.name
  container_access_type = "private"
}
...
resource "azurerm_storage_queue" "storage_queue" {
  name                 = "vector-db-calibration-request"
  storage_account_name = azurerm_storage_account.storage_account.name
}
